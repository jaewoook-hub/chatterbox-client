describe('chatterbox', function() {
  ...
  //   //     console.log('should submit a POST request via $.ajax');
  //   //     Parse.create({});
  ...
  //   //     console.log('should send the message along with the request as a stringified object');
  //   //     var message = {
  //   //       username: 'Mel Brooks',
  ...
  //   //     console.log('should send the correct message along with the request');
  //   //     var message = {
  //   //       username: 'Mel Brooks',
  //   //       text: 'It\'s good to be the king',
  //   //       roomname: 'lobby'
